...
let averageAge = calculateAverageAge(data);
console.log("Average Age:", averageAge);


// Problem 2

function filterPersonsUnder20(data) {
    let personsUnder20 = [];
    for (const person of data) {
      if (person.age < 20) {
        personsUnder20.push(person);
      }
    }
    return personsUnder20;
  }

let personsUnder20 = filterPersonsUnder20(data);
console.log("Persons Younger Than 20:", personsUnder20);

// Problem 3
function getNamesAndSurnames(data) {
    let namesAndSurnames = data.map(person => `${person.firstname} ${person.lastname}`);
    return namesAndSurnames;
}

let namesAndSurnames = getNamesAndSurnames(data);
console.log("Names and Surnames:", namesAndSurnames);
...
//   Problem5
function getFirstUserOver40(data) {
    let userOver40 = data.find(person => person.age > 40);
    return userOver40;
  }

  let firstUserOver40 = getFirstUserOver40(data);
console.log("First User Over 40:", firstUserOver40);
// Problem 6
let myArray = [1, 2, 3, 4, 5];
let elementToRemove = 3;
let newArray = removeElementFromArray(myArray, elementToRemove);
